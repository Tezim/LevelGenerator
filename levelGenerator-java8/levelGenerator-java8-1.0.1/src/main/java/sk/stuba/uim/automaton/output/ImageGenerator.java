        ...
        for (int i = 0 ; i < grid.getWidth(); i++){
            for (int j = 0; j < grid.getHeight(); j++){
                switch(grid.getGrid()[j][i].getState().getTileType()){
                    case WATER : { g.drawImage(water,i * scale_x,j * scale_y, scale_x, scale_y,null);break;}
                    case LAND  : { g.drawImage(land,i * scale_x,j * scale_y, scale_x, scale_y,null);break;}
                    case SAND  : { g.drawImage(sand,i * scale_x,j * scale_y, scale_x, scale_y,null);break;}
                    case STONE : { g.drawImage(stone,i * scale_x,j * scale_y, scale_x, scale_y,null);break;}
                    case ALIVE : { g.drawImage(alive,i * scale_x,j * scale_y, scale_x, scale_y,null);break;}
                    case DEAD  : { g.drawImage(dead,i * scale_x,j * scale_y, scale_x, scale_y,null); break;}
                    case LAVA  : { g.drawImage(lava,i * scale_x,j * scale_y, scale_x, scale_y,null); break;}
                    case EMPTY:  break;
                    case DEFAULT : {
                    }
